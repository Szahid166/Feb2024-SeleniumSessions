...
//				System.out.println(title);
				...
				JavaScripUtil jsUtil = new JavaScripUtil(driver);
				String title = jsUtil.getTitleByJs();
				System.out.println(title);//HubSpot Login and Sign in
				
				String url =  jsUtil.getURLByJs();
				System.out.println(url);//https://app.hubspot.com/login
				
				jsUtil.generateJSAlert("landed on login page");
				
//				// Capture all the text from the page
