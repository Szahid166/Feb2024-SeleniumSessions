...
//css: locator	
	...
	//Formula: htmltag#id
	//input#input-email → does not need any forward slash
	
	//class formula: .className
	               // htmltag.className
              	   // .form-control
	               // input.form-control → you can write with or without htmltag
	               // img.img-responsive
  ...
  //.c1.c2.c3....cn
  		...
  		// combine Id and class together in any order sequence
	...
	//input[@name='email'] --xpath
  		...
  		//Formula:  htmltag[attr1='value'][attr2='value'][attr3='value']
  		...
  		// input[placeholder*='E-Mail'] --contains address
